...
describe("query builder > joins", () => {
    ...
    describe("leftJoinAndSelect", () => {
        it("should load data for all relation types", () => Promise.all(connections.map(async (connection) => {
            ...
            (0, chai_1.expect)(loadedPosts[0].categories[0].images).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPosts[0].categories[0].images.length).to.be.equal(2);
            (0, chai_1.expect)(loadedPosts[0].categories[0].images.map((image) => image.id)).to.have.members([1, 2]);
            (0, chai_1.expect)(loadedPosts[0].author).to.not.be.undefined;
            (0, chai_1.expect)(loadedPosts[0].author.id).to.be.equal(1);
            (0, chai_1.expect)(loadedPosts[1].categories).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPosts[1].categories.length).to.be.equal(1);
            (0, chai_1.expect)(loadedPosts[1].categories[0].images).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPosts[1].categories[0].images.length).to.be.equal(1);
            (0, chai_1.expect)(loadedPosts[1].categories[0].images[0].id).to.be.equal(3);
            ...
            (0, chai_1.expect)(loadedPost.tag instanceof Tag_1.Tag).to.be.true;
            ...
            (0, chai_1.expect)(loadedPost.categories[0] instanceof Category_1.Category).to.be
                .true;
            (0, chai_1.expect)(loadedPost.categories[0].id).to.be.equal(1);
            (0, chai_1.expect)(loadedPost.categories[1].id).to.be.equal(2);
            (0, chai_1.expect)(loadedPost.categories[0].images[0] instanceof Image_1.Image)
                .to.be.true;
            (0, chai_1.expect)(loadedPost.categories[0].images).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPost.categories[0].images.length).to.be.equal(2);
            (0, chai_1.expect)(loadedPost.categories[0].images.map((image) => image.id)).to.have.members([1, 2]);
            (0, chai_1.expect)(loadedPost.categories[1].images).to.be.eql([]);
            (0, chai_1.expect)(loadedPost.author).to.not.be.undefined;
            (0, chai_1.expect)(loadedPost.author instanceof User_1.User).to.be.true;
            (0, chai_1.expect)(loadedPost.author.id).to.be.equal(1);
        })));
        it("should load data when additional condition used", () => Promise.all(connections.map(async (connection) => {
            ...
            const loadedPost = await connection.manager
                ...
                .getOne();
            (0, chai_1.expect)(loadedPost.categories).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPost.categories.length).to.be.equal(1);
            (0, chai_1.expect)(loadedPost.categories[0].id).to.be.equal(1);
            (0, chai_1.expect)(loadedPost.categories[0].images).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPost.categories[0].images.length).to.be.equal(1);
            (0, chai_1.expect)(loadedPost.categories[0].images[0].id).to.be.equal(2);
        })));
        it("should load data when join tables does not have direct relation", () => Promise.all(connections.map(async (connection) => {
            ...
            if (connection.driver.options.type === "cockroachdb") {
                (0, chai_1.expect)(loadedRawPost["categories_id"]).to.be.equal("1");
            }
            else {
                (0, chai_1.expect)(loadedRawPost["categories_id"]).to.be.equal(1);
            }
    ...
    describe("leftJoinAndMap", () => {
        ...
        it("should load and map selected data when query builder used as join argument", () => Promise.all(connections.map(async (connection) => {
            const tag = new Tag_1.Tag();
            tag.name = "audi";
            await connection.manager.save(tag);
            const post = new Post_1.Post();
            ...
            const loadedPost = await connection.manager
                .createQueryBuilder(Post_1.Post, "post")
                .leftJoinAndMapOne("post.tag", (qb) => qb.from(Tag_1.Tag, "tag"), "tag", "tag.id = post.tagId", undefined, Tag_1.Tag)
                .where("post.id = :id", { id: post.id })
                .getOne();
            (0, chai_1.expect)(loadedPost.tag).to.not.be.undefined;
            (0, chai_1.expect)(loadedPost.tag.id).to.be.equal(1);
        ...
        it("should load and map selected data when data will given from same entity but with different conditions", () => Promise.all(connections.map(async (connection) => {
            ...
            (0, chai_1.expect)(loadedPost.categories).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPost.categories.length).to.be.equal(2);
            (0, chai_1.expect)(loadedPost.subcategories).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPost.subcategories.length).to.be.equal(1);
        })));
        it("should load and map selected data when data will given from same property but with different conditions", () => Promise.all(connections.map(async (connection) => {
            ...
            const loadedPosts = await connection.manager
                ...
                .getMany();
            (0, chai_1.expect)(loadedPosts[0].removedCategories).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPosts[0].removedCategories.length).to.be.equal(1);
            (0, chai_1.expect)(loadedPosts[0].removedCategories[0].id).to.be.equal(3);
            (0, chai_1.expect)(loadedPosts[0].removedCategories[0] instanceof
                Category_1.Category).to.be.true;
            (0, chai_1.expect)(loadedPosts[0].removedCategories[0].removedImages
                .length).to.be.equal(1);
            (0, chai_1.expect)(loadedPosts[0].removedCategories[0]
                .removedImages[0] instanceof Image_1.Image).to.be.true;
            (0, chai_1.expect)(loadedPosts[0].removedCategories[0].removedImages[0]
                .id).to.be.equal(3);
            (0, chai_1.expect)(loadedPosts[0].subcategories).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPosts[0].subcategories.length).to.be.equal(2);
            (0, chai_1.expect)(loadedPosts[0].subcategories[0].titleImage.id).to.be.equal(1);
            (0, chai_1.expect)(loadedPosts[1].removedCategories).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPosts[1].removedCategories.length).to.be.equal(1);
            (0, chai_1.expect)(loadedPosts[1].removedCategories[0].id).to.be.equal(4);
            (0, chai_1.expect)(loadedPosts[1].removedCategories[0] instanceof
                Category_1.Category).to.be.true;
            (0, chai_1.expect)(loadedPosts[1].removedCategories[0].removedImages
                .length).to.be.equal(1);
            (0, chai_1.expect)(loadedPosts[1].removedCategories[0]
                .removedImages[0] instanceof Image_1.Image).to.be.true;
            (0, chai_1.expect)(loadedPosts[1].removedCategories[0].removedImages[0]
                .id).to.be.equal(4);
            (0, chai_1.expect)(loadedPosts[1].subcategories).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPosts[1].subcategories.length).to.be.equal(1);
            (0, chai_1.expect)(loadedPosts[1].subcategories[0].titleImage.id).to.be.equal(1);
            const loadedPost = await connection.manager
                .createQueryBuilder(Post_1.Post, "post")
                .leftJoinAndMapMany("post.removedCategories", "post.categories", "rc", "rc.isRemoved = :isRemoved")
                .leftJoinAndMapMany("rc.removedImages", "rc.images", "removedImages", "removedImages.isRemoved = :isRemoved")
                ...
                .where("post.id = :id", { id: post.id })
                .getOne();
            (0, chai_1.expect)(loadedPost.removedCategories).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPost.removedCategories.length).to.be.equal(1);
            (0, chai_1.expect)(loadedPost.removedCategories[0].id).to.be.equal(3);
            (0, chai_1.expect)(loadedPost.removedCategories[0] instanceof Category_1.Category)
                .to.be.true;
            (0, chai_1.expect)(loadedPost.removedCategories[0].removedImages.length).to.be.equal(1);
            (0, chai_1.expect)(loadedPost.removedCategories[0]
                .removedImages[0] instanceof Image_1.Image).to.be.true;
            (0, chai_1.expect)(loadedPost.removedCategories[0].removedImages[0].id).to.be.equal(3);
            (0, chai_1.expect)(loadedPost.subcategories).to.not.be.eql([]);
            (0, chai_1.expect)(loadedPost.subcategories.length).to.be.equal(2);
            (0, chai_1.expect)(loadedPost.subcategories[0].titleImage.id).to.be.equal(1);
        })));
    });
    describe("innerJoinAndMap", () => {
        ...
        it("should load and map selected data when query builder used as join argument", () => Promise.all(connections.map(async (connection) => {
            ...
            const loadedPost = await connection.manager
                .createQueryBuilder(Post_1.Post, "post")
                .innerJoinAndMapOne("post.tag", (qb) => qb.from(Tag_1.Tag, "tag"), "tag", "tag.id = post.tagId", undefined, Tag_1.Tag)
                .where("post.id = :id", { id: post.id })
                .getOne();
            (0, chai_1.expect)(loadedPost.tag).to.not.be.undefined;
            (0, chai_1.expect)(loadedPost.tag.id).to.be.equal(1);
        ...
        it("should not return any result when related data does not exist", () => Promise.all(connections.map(async (connection) => {
            ...
            const loadedPost1 = await connection.manager
                ...
                .getOne();
            (0, chai_1.expect)(loadedPost1).to.be.null;
