...
const ArrayOverlap_1 = require("../../../../src/find-options/operator/ArrayOverlap");
describe("find options > find operators > ArrayOverlap", () => {
    ...
    it("should find entries in regular arrays", () => Promise.all(connections.map(async (connection) => {
        ...
        const loadedPost1 = await connection.manager.find(Post_1.Post, {
            where: {
                authors: (0, ArrayOverlap_1.ArrayOverlap)(["dmitry", "umed"]),
            },
            order: {
                id: "asc",
            },
        ...
        const loadedPost2 = await connection.manager.find(Post_1.Post, {
            where: {
                authors: (0, ArrayOverlap_1.ArrayOverlap)(["olimjon", "umed"]),
            },
            order: {
                id: "asc",
            },
    ...
    it("should find entries in enum arrays", () => Promise.all(connections.map(async (connection) => {
        ...
        const loadedPost1 = await connection.manager.find(Post_1.Post, {
            where: {
                statuses: (0, ArrayOverlap_1.ArrayOverlap)([
                    Post_1.PostStatus.draft,
                    Post_1.PostStatus.unknown,
                ]),
            },
            order: {
                id: "asc",
...
//# sourceMappingURL=array-overlap-operator.test.js.map