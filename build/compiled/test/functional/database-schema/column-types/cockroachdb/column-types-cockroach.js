...
describe("database schema > column types > cockroachdb", () => {
    ...
    it("all types should work correctly - persist and hydrate", () => Promise.all(connections.map(async (connection) => {
        ...
        loadedPost.multilinestring.should.deep.include(post.multilinestring);
        loadedPost.multipolygon.should.deep.include(post.multipolygon);
        loadedPost.geometrycollection.should.deep.include(post.geometrycollection);
        loadedPost.point_geography.should.deep.include(post.point_geography);
        loadedPost.linestring_geography.should.deep.include(post.linestring_geography);
        loadedPost.polygon_geography.should.deep.include(post.polygon_geography);
        loadedPost.multipoint_geography.should.deep.include(post.multipoint_geography);
        loadedPost.multilinestring_geography.should.deep.include(post.multilinestring_geography);
        loadedPost.multipolygon_geography.should.deep.include(post.multipolygon_geography);
        loadedPost.geometrycollection_geography.should.deep.include(post.geometrycollection_geography);
