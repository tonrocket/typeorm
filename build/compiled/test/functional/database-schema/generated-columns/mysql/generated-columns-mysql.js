...
describe("database schema > generated columns > mysql", () => {
    ...
    it("should create table with generated columns", () => Promise.all(dataSources.map(async (dataSource) => {
        ...
        storedFullName.asExpression.should.be.equal("CONCAT(`firstName`,' ',`lastName`)");
        ...
        complexColumn.asExpression.should.be.equal("concat(if(((not `useTitle`) or IsNull(`title`)), '', concat(`firstName`,' ', `lastName`)))");
    ...
    it("should change generated column and revert change", () => Promise.all(dataSources.map(async (dataSource) => {
        ...
        storedFullName.asExpression.should.be.equal("concat('Mr. ',`firstName`,' ',`lastName`)");
...
//# sourceMappingURL=generated-columns-mysql.js.map