...
describe("spatial-cockroachdb", () => {
    ...
    it("should create correct schema with geometry type", () => Promise.all(connections.map(async (connection) => {
    ...
    it("should create correct schema with geography type", () => Promise.all(connections.map(async (connection) => {
        const queryRunner = connection.createQueryRunner();
        const schema = await queryRunner.getTable("post");
        await queryRunner.release();
        (0, chai_1.expect)(schema).not.to.be.undefined;
    ...
    it("should create correct schema with geometry indices", () => Promise.all(connections.map(async (connection) => {
        const queryRunner = connection.createQueryRunner();
        const schema = await queryRunner.getTable("post");
        await queryRunner.release();
        (0, chai_1.expect)(schema).not.to.be.undefined;
...
//# sourceMappingURL=spatial-cockroachdb.js.map