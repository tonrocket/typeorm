...
dataSource.initialize().then((dataSource) => {
    let categoryRepository = dataSource.getTreeRepository(Category_1.Category);
    let childChildCategory1 = new Category_1.Category();
    childChildCategory1.name = "Child #1 of Child #1 of Category #1";
    let childChildCategory2 = new Category_1.Category();
    childChildCategory2.name = "Child #1 of Child #2 of Category #1";
    let childCategory1 = new Category_1.Category();
    childCategory1.name = "Child #1 of Category #1";
    childCategory1.childCategories = [childChildCategory1];
    let childCategory2 = new Category_1.Category();
