...
const EverythingEntity_1 = require("./entity/EverythingEntity");
const options = {
    type: "mysql",
    host: "localhost",
    port: 3306,
...
dataSource.initialize().then((dataSource) => {
    let entity = new EverythingEntity_1.EverythingEntity();
    ...
    let postRepository = dataSource.getRepository(EverythingEntity_1.EverythingEntity);
    postRepository
        .save(entity)
        .then((entity) => {
